...
public sealed class MarkdownRenderer
{
    ...
    /// </summary>
    public const string VirtualHost = "md-editor.local";
    ...
    /// base64 images.
    /// </summary>
    public const string PreviewVirtualHost = "md-editor-preview.local";
    ...
    private static string BuildDocument(string innerHtml, string baseHrefRaw, string? sourceFilePath, CatppuccinFlavor flavor)
    {
        ...
        var titleSrc = sourceFilePath is null ? "MD Editor" : Path.GetFileName(sourceFilePath);
